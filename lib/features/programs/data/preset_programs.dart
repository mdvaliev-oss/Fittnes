      ...
      ProgramDay(
        ...
        exercises: [
          ...
          ProgramExercise(
            ...
            exerciseName: 'Подъём на носки стоя',
            sets: 3,
            targetMin: 10,
            targetMax: 15,
          ),
      ...
      ProgramDay(
        ...
        exercises: [
          ...
          ProgramExercise(
            ...
            exerciseName: 'Жим гантелей в наклоне',
            sets: 3,
            targetMin: 10,
            targetMax: 12,
          ),
          ProgramExercise(
            ...
            exerciseName: 'Махи гантелями в стороны',
            sets: 3,
            targetMin: 12,
            targetMax: 15,
          ),
          ProgramExercise(
            ...
            exerciseName: 'Разгибания на блоке',
            sets: 3,
            targetMin: 12,
            targetMax: 15,
          ),
      ...
      ProgramDay(
        ...
        exercises: [
          ...
          ProgramExercise(
            ...
            exerciseName: 'Горизонтальная тяга блока',
            sets: 3,
            targetMin: 10,
            targetMax: 12,
          ),
      ...
      ProgramDay(
        ...
        exercises: [
          ...
          ProgramExercise(
            ...
            exerciseName: 'Ягодичный мост со штангой',
            sets: 3,
            targetMin: 10,
            targetMax: 12,
          ),
